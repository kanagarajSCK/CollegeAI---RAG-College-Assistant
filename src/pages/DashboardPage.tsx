      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-gray-200">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 text-xs font-semibold text-gray-700 bg-white hover:bg-gray-50 border border-gray-200 rounded-lg shadow-2xs transition-colors"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-5 bg-white border border-gray-200 rounded-xl shadow-2xs space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-gray-500">Knowledge Base Documents</span>
        ...
        <div className="p-5 bg-white border border-gray-200 rounded-xl shadow-2xs space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-gray-500">Vector Embeddings Indexed</span>
            <div className="p-2 bg-gray-100 text-gray-700 rounded-lg">
              <Layers className="w-4 h-4" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-bold text-gray-900">{totalChunks}</span>
        ...
        <div className="p-6 bg-indigo-50/70 border border-indigo-200 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-indigo-800 max-w-xl leading-relaxed">
              Load our comprehensive sample pack containing the Academic Calendar, Hostel Guidelines & Fee Structure, Placement Regulations, and Examination Grading System to test RAG questions immediately.
            </p>
          </div>
          ...
          <button
            ...
            className="shrink-0 px-4 py-2 text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg shadow-xs shadow-indigo-100 transition-colors disabled:opacity-60"
          >
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-2xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-gray-100">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold text-gray-900">Recently Uploaded Documents</h2>
            </div>
            <button
              onClick={() => setActiveTab('documents')}
          ...
          <div className="space-y-2.5">
            {documents.slice(0, 4).map(doc => (
              <div
                key={doc._id}
                onClick={() => setActiveTab('documents')}
                className="flex items-center justify-between p-3 bg-gray-50 hover:bg-gray-100/80 rounded-xl transition-colors cursor-pointer"
              >
                <div className="flex items-center gap-3 min-w-0 pr-2">
                  <div className="w-8 h-8 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-indigo-600 shrink-0 font-bold text-[10px]">
          ...
          <div className="space-y-2.5">
            {conversations.slice(0, 4).map(conv => (
              <div
                ...
                className="flex items-center justify-between p-3 bg-gray-50 hover:bg-indigo-50/50 rounded-xl transition-colors cursor-pointer group"
              >
